...
#include "com_yangeit_mp3recorder_util_LameUtil.h"
#include <stdio.h>
#include <jni.h>

static lame_global_flags *lame = NULL;

JNIEXPORT void JNICALL Java_com_yangeit_mp3recorder_util_LameUtil_init(
...
JNIEXPORT jint JNICALL Java_com_yangeit_mp3recorder_util_LameUtil_encode(
...
JNIEXPORT jint JNICALL Java_com_yangeit_mp3recorder_util_LameUtil_flush(
...
JNIEXPORT void JNICALL Java_com_yangeit_mp3recorder_util_LameUtil_close
